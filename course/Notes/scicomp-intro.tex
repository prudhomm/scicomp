...
\begin{frame}{Projects}
  \begin{block}{Projects}
   \begin{itemize}
    \item Engineering design of a cooling system for CPUs
    \item Sterilization
    \item ...
   \end{itemize}
  \end{block}
...
\begin{frame}{A vision for home computing}
  ...
  \begin{columns}
    ...
    \begin{figure}[htbp]
      \centering
      \mode<presentation>{\includegraphics[width=1.2\textwidth]{../figures/computer_pioneer.png}}
      \mode<article>{\includegraphics[width=\figwidth\textwidth]{../figures/computer_pioneer.png}}
