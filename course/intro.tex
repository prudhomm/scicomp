...
\begin{frame} \frametitle{Horaires des Cours/TPs}
  \begin{itemize}
  \item Les cours auront lieu en F211 de 8:00 à 9:30 
  \item les TP et Projets auront lieu
    \begin{itemize}
    \item en F212 de 17:00 à 18:30 les semaines 2,3,4,5
    \item en F218 de 8:00 à   9:30 les semaines 5,6,7,9,10
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame} \frametitle{Note Finale}
  \begin{itemize}
  \item $N_p$ note projet(environ 10 minutes de présentation et 5 minutes de questions)
...
\begin{frame}{Notes de Cours, TP et Projets}
  ...
  \begin{block}{}
    ...
    \item Les notes de cours, les TP et projets seront disponibles sur
      le Bureau Virtuel Rhones Alpes (à partir du 15 Janvier)
    \item Les notes de cours seront disponibles après que le cours ait
      été donné
    \item Une liste de projets sera disponible courant Janvier
    \item Les TP doivent être rendus la veille du cours au plus tard à minuit 
    \end{itemize}
  \end{block}

\end{frame}

\begin{frame}{Quelques Idées de Projets}
  \begin{block}{}
    
    \begin{itemize}
    \item Simulation d'une système de refroidissement pour un
      micro-processeur
    \item Simulation d'un micro-onde en 2D et 3D
    \item Multigrille parallèle avec Trilinos
    \end{itemize}
    \alert{Vous pouvez également proposer des sujets }
  \end{block}
\end{frame}
